# Pasos para iniciarse con typescript
...
3. Instalar las dependencias de desarrollo, se puede utilizar npm o pnpm
   ...
   Vamos a especificar las versiones de typescript y tsc-watch en la instalación para evitar que cambios en los parámetros entre el momento de escribir el documento y cuando se lo estén siguiendo puedan causar comportamientos diferentes. Esto instalará la utilidad de compilación de typescript tsc y tsc-watch que utilizaremos para el hot-reload
...
4. Generar la configuración de compilación de tsconfig.json
   ...
   TypeScript se debe compilar a javascript que luego se ejecuta sobre Node.js, por ello crearemos una config para TypeScript
...
8. Configurar VS Code / Codium para incluir extensiones en los imports
   ...
   Debido a recientes cambios en las versiones más nuevas de TS y Node.js al usar "type":"module" y con la configuración que estamos utilizando, al tratar de ejecutar el código los imports de Node.js nos requerirán que incluyamos la extensión del mismo.
