...
async function findAll(req: Request, res: Response) {
  try {
    ...
    res.status(200).json({ message: 'Se encontraron todos los personajes', data: characters })
  } catch (error: any) {
...
async function findOne(req: Request, res: Response) {
  try {
    ...
    res.status(200).json({ message: 'Personaje encontrado', data: character })
  } catch (error: any) {
    res.status(500).json({ message: error.message })
  }
}
...
async function add(req: Request, res: Response) {
  try {
    ...
    await em.flush()
    res.status(201).json({ message: 'Personaje creado', data: character })
  } catch (error: any) {
    res.status(500).json({ message: error.message })
  }
}
...
async function update(req: Request, res: Response) {
  try {
    ...
    res
      .status(200)
      .json({ message: 'Personaje actualizado', data: characterToUpdate })
  } catch (error: any) {
    res.status(500).json({ message: error.message })
  }
}
